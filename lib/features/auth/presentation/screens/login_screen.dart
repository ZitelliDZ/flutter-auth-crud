...
import 'package:auth_app/features/auth/presentation/providers/login_form_provider.dart';
...
class _LoginForm extends ConsumerWidget {
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    final providerLogin = ref.watch(loginFormProvider);

    ref.listen(authProvider,(previous, next) {
      if (next.errorMessage.isEmpty)  return showSnackBarsuccess(context);
        ...
        children: [
          ...
          const SizedBox( height: 90 ),
           ...
           CustomTextFormField(
            ...
            errorMessage: providerLogin.isFormPosted ? providerLogin.email.errorMessage:null,
          ),
          const SizedBox( height: 30 ),
           ...
           CustomTextFormField(
            ...
            errorMessage: providerLogin.isFormPosted ? providerLogin.password.errorMessage : null,
          ),
