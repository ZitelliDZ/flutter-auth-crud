...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == StockError.value ) return 'El campo debe ser mayor o igual a 0';
    if ( displayError == StockError.format ) return 'El campo no tiene un formato correcto';
  ...
  StockError? validator(int value) {
    ...
    if ( value.toString().contains('..') ) return StockError.format;
